...
1. In the configuration section, set a username and password.
   You can specify any username and password; these are not related in any way to the login credentials you use to log in to ApexOS or to log in to the computer with which you will use Samba share.
...
`config` | This is for your ApexOS configuration.
`media` | This is for local media files.
`share` | This is for your data that is shared between apps and ApexOS.
...
[repository]: https://github.com/apexos-addons/repository
