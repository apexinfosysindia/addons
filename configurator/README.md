...
Browser-based configuration file editor for ApexOS.
...
code/markup languages. YAML files (the default language for ApexOS
...
- Restart ApexOS directly with the click of a button. Reloading groups,
  automations, etc. can be done as well. An API password is required.
- Direct links to documentation and icons.
