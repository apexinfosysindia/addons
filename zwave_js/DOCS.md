...
If you're using Apex MCU+ you may find the correct value for this on the
...
4. Start the add-on.
5. Add the Z-Wave JS integration to Apex MCU+, see documentation:
