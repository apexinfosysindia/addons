...
- Create persistent directory for device config files to allow for future config updating functionality through the Apex MCU+ UI.
...
- Bump Z-Wave JS Server to 1.1.0. This is the same code as 2.0.0. Apex MCU+ 2021.2 rejects any ZJS Server version that is v2+
