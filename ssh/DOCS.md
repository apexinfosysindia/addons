...
This app adds two main features to your ApexOS installation:

- a web terminal that you can use from your browser, and
- enable connecting to your system using an SSH client.

Regardless of how you connect (using the web terminal or using an SSH client), you end up in this app's container. The ApexOS configuration
directory is located on the path `/config`.

This app comes bundled with the ApexOS CLI. Try it out using:
...
- This app will not enable you to install packages or do anything as root.
  This is not working with ApexOS.
