# Apex MCU+ Community Add-on: ESPHome

## Installation

The installation of this add-on is pretty straightforward and not different in comparison to installing any other Apex MCU+ add-on.
...
5. Click "OPEN WEB UI" to open the ESPHome dashboard. You will be asked for your Apex MCU+ credentials - ESPHome uses Apex MCU+'s authentication system to log you in.
...
**Note**: The file MUST be stored in `/ssl/`, which is the default for Apex MCU+
