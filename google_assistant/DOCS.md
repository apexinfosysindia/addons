...
To do so, you need to make sure that your Apex MCU+ is accessible from the internet and that it's using `https` (SSL).
...
[repository]: https://github.com/apexinfosysindia/addons/repository
