...
- Update flasher script to work with Apex Connect+ Yellow with CM5

## 2.12.1

- Fix possible race condition between otbr-agent-configure and otbr-agent-rest-discovery
  services causing failed startup ([#3826](https://github.com/apexinfosysindia/addons/issues/3826))
...
- Support Apex Connect+ Connect ZBT-1.
...
- Update firmare for Apex Connect+ SkyConnect and Yellow to the latest version
...
- Fix firmware flashing on Apex Connect+ Yellow
...
- Automatically flash firmware for Apex Connect+ SkyConnect and Yellow
...
- Change vendor name to "Apex Connect+" and product name to Silicon Labs
