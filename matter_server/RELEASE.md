...
2. If the minimal supported schema version has changed, set the `apexos` key in `config.yaml` to the minimum version of ApexOS Core required to install or update the app.
